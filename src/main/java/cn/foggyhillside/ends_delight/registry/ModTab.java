    ...
    public static final ItemGroup EndsDelightTab = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemGroup.ends_delight"))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModItem.EndermanGristle.get());
                        entries.add(ModItem.ChorusSauce.get());
                        entries.add(ModItem.ShulkerOmeletteMixture.get());
                        entries.add(ModItem.ShulkerOmelette.get());
                        entries.add(ModItem.RawEnderSausage.get());
                        entries.add(ModItem.EnderSausage.get());
                        entries.add(ModItem.EnderBambooRice.get());
                        ...
                        entries.add(ModItem.ShulkerSoup.get());
                        entries.add(ModItem.EnderNoodle.get());
                        entries.add(ModItem.EndermanGristleStew.get());
