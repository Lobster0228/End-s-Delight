...
public class ModBlock {
    ...
    public static final Block ChorusFruitPie = registerBlock("chorus_fruit_pie", new ChorusFruitPieBlock(FabricBlockSettings.copy(Blocks.CAKE), ModItem.ChorusFruitPieSlice.get()));
