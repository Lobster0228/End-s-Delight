...
public enum ModItem {
    ...
    DragonEggShellKnife("dragon_egg_shell_knife",
            () -> new KnifeItem(ModMaterials.DRAGON_EGG_SHELL)),
    PurpurKnife("purpur_knife",
            () -> new KnifeItem(ModMaterials.PURPUR)),
    EndStoneKnife("end_stone_knife",
            () -> new KnifeItem(ModMaterials.END_STONE)),
    DragonToothKnife("dragon_tooth_knife",
            () -> new KnifeItem(ModMaterials.DRAGON_TOOTH)),
