...
public enum ModItem {
    ...
    EndermanGristle("enderman_gristle",
            () -> new EndermanGristleItem(new FabricItemSettings().food(FoodList.EndermanGristle).group(ModItemGroup.ITEM_GROUP), 0.3F, false)),
    ChorusSauce("chorus_sauce",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.ChorusSauce).recipeRemainder(Items.BOWL).maxCount(64).group(ModItemGroup.ITEM_GROUP))),
    ShulkerOmeletteMixture("shulker_omelette_mixture",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.ShulkerOmeletteMixture).group(ModItemGroup.ITEM_GROUP),true)),
    ShulkerOmelette("shulker_omelette",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.ShulkerOmelette).group(ModItemGroup.ITEM_GROUP),true)),
    RawEnderSausage("raw_ender_sausage",
            () -> new EndermanGristleItem(new FabricItemSettings().food(FoodList.RawEnderSausage).group(ModItemGroup.ITEM_GROUP), 0.3F, false)),
    EnderSausage("ender_sausage",
            () -> new EndermanGristleStewItem(new FabricItemSettings().food(FoodList.EnderSausage).group(ModItemGroup.ITEM_GROUP), 0.2F, true, true)),
    EnderBambooRice("ender_bamboo_rice",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.EnderBambooRice).group(ModItemGroup.ITEM_GROUP), true)),
    ...
    ChorusFruitWine ("chorus_fruit_wine",
            () -> new ChorusFruitWineItem(new FabricItemSettings().food(FoodList.ChorusFruitWine).maxCount(16).recipeRemainder(Items.GLASS_BOTTLE).group(ModItemGroup.ITEM_GROUP))),
    ...
    ShulkerSoup("shulker_soup",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.ShulkerSoup).recipeRemainder(Items.BOWL).maxCount(16).group(ModItemGroup.ITEM_GROUP), true)),
    //ConsumableItem
    EnderNoodle("ender_noodle",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.EnderNoodle).recipeRemainder(Items.BOWL).maxCount(16).group(ModItemGroup.ITEM_GROUP), true)),
    EndermanGristleStew("enderman_gristle_stew",
            () -> new EndermanGristleStewItem(new FabricItemSettings().food(FoodList.EndermanGristleStew).recipeRemainder(Items.BOWL).maxCount(16).group(ModItemGroup.ITEM_GROUP), 0.2F, true, true)),
    ...
    AssortedSalad("assorted_salad",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.AssortedSalad).recipeRemainder(Items.SHULKER_SHELL).maxCount(16).group(ModItemGroup.ITEM_GROUP), true)),
    //BarbecueStick
