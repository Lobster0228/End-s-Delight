...
public enum ModItem {
    ...
    DragonEggShellKnife("dragon_egg_shell_knife",
            () -> new KnifeItem(ModMaterials.DRAGON_EGG_SHELL, 0.5F, -2.0F, new FabricItemSettings())),
    PurpurKnife("purpur_knife",
            () -> new KnifeItem(ModMaterials.PURPUR, 0.5F, -2.0F, new FabricItemSettings())),
    EndStoneKnife("end_stone_knife",
            () -> new KnifeItem(ModMaterials.END_STONE, 0.5F, -2.0F, new FabricItemSettings())),
    DragonToothKnife("dragon_tooth_knife",
            () -> new KnifeItem(ModMaterials.DRAGON_TOOTH, 0.5F, -2.0F, new FabricItemSettings())),
    ...
    EndermanGristle("enderman_gristle",
            () -> new EndermanGristleItem(new FabricItemSettings().food(FoodList.EndermanGristle), 0.3F, false)),
    ChorusSauce("chorus_sauce",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.ChorusSauce).recipeRemainder(Items.BOWL).maxCount(64))),
    ShulkerOmeletteMixture("shulker_omelette_mixture",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.ShulkerOmeletteMixture),true)),
    ShulkerOmelette("shulker_omelette",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.ShulkerOmelette),true)),
    RawEnderSausage("raw_ender_sausage",
            () -> new EndermanGristleItem(new FabricItemSettings().food(FoodList.RawEnderSausage), 0.3F, false)),
    EnderSausage("ender_sausage",
            () -> new EndermanGristleStewItem(new FabricItemSettings().food(FoodList.EnderSausage), 0.2F, true, true)),
    EnderBambooRice("ender_bamboo_rice",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.EnderBambooRice), true)),
    ...
    ChorusFruitWine("chorus_fruit_wine",
            () -> new ChorusFruitWineItem(new FabricItemSettings().food(FoodList.ChorusFruitWine).recipeRemainder(Items.GLASS_BOTTLE).maxCount(16))),
    ...
    ChorusFruitPieSlice("chorus_fruit_pie_slice",
            () -> new ChorusFruitPieSliceItem(new FabricItemSettings().food(FoodValues.PIE_SLICE), true)),
    //Congee
    ...
    ShulkerSoup("shulker_soup",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.ShulkerSoup).recipeRemainder(Items.BOWL).maxCount(16), true)),
    //ConsumableItem
    EnderNoodle("ender_noodle",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.EnderNoodle).recipeRemainder(Items.BOWL).maxCount(16), true)),
    EndermanGristleStew("enderman_gristle_stew",
            () -> new EndermanGristleStewItem(new FabricItemSettings().food(FoodList.EndermanGristleStew).recipeRemainder(Items.BOWL).maxCount(16), 0.2F, true, true)),
    ...
    AssortedSalad("assorted_salad",
            () -> new ConsumableItem(new FabricItemSettings().food(FoodList.AssortedSalad).recipeRemainder(Items.SHULKER_SHELL).maxCount(16), true)),
    //BarbecueStick
