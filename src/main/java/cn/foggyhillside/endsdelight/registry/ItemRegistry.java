...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> EndermanGristle = ITEMS.register("enderman_gristle",
            () -> new EndermanGristleItem(new Item.Properties().food(FoodList.EndermanGristle).tab(EndsDelight.EndsDelightTab), 0.3F, false));
    public static final RegistryObject<Item> ChorusSauce = ITEMS.register("chorus_sauce",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ChorusSauce).craftRemainder(Items.BOWL).stacksTo(64).tab(EndsDelight.EndsDelightTab)));
    public static final RegistryObject<Item> ShulkerOmeletteMixture = ITEMS.register("shulker_omelette_mixture",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ShulkerOmeletteMixture).tab(EndsDelight.EndsDelightTab),true));
    public static final RegistryObject<Item> ShulkerOmelette = ITEMS.register("shulker_omelette",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ShulkerOmelette).tab(EndsDelight.EndsDelightTab),true));
    public static final RegistryObject<Item> RawEnderSausage = ITEMS.register("raw_ender_sausage",
            () -> new EndermanGristleItem(new Item.Properties().food(FoodList.RawEnderSausage).tab(EndsDelight.EndsDelightTab), 0.3F, false));
    public static final RegistryObject<Item> EnderSausage = ITEMS.register("ender_sausage",
            () -> new EndermanGristleStewItem(new Item.Properties().food(FoodList.EnderSausage).tab(EndsDelight.EndsDelightTab), 0.2F, true, true));
    public static final RegistryObject<Item> EnderBambooRice = ITEMS.register("ender_bamboo_rice",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.EnderBambooRice).tab(EndsDelight.EndsDelightTab), true));
    ...
    public static final RegistryObject<Item> ShulkerSoup = ITEMS.register("shulker_soup",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.ShulkerSoup).craftRemainder(Items.BOWL).stacksTo(16).tab(EndsDelight.EndsDelightTab), true));
    //ConsumableItem
    public static final RegistryObject<Item> EnderNoodle = ITEMS.register("ender_noodle",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.EnderNoodle).craftRemainder(Items.BOWL).stacksTo(16).tab(EndsDelight.EndsDelightTab), true));
    public static final RegistryObject<Item> EndermanGristleStew = ITEMS.register("enderman_gristle_stew",
            () -> new EndermanGristleStewItem(new Item.Properties().food(FoodList.EndermanGristleStew).craftRemainder(Items.BOWL).stacksTo(16).tab(EndsDelight.EndsDelightTab), 0.2F, true, true));
    ...
    public static final RegistryObject<Item> AssortedSalad = ITEMS.register("assorted_salad",
            () -> new ConsumableItem(new Item.Properties().food(FoodList.AssortedSalad).craftRemainder(Items.SHULKER_SHELL).stacksTo(16).tab(EndsDelight.EndsDelightTab), true));
    //BarbecueStick
